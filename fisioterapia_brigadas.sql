...
CREATE TABLE `brigadas` (
  ...
  CONSTRAINT `brigadas_ibfk_1` FOREIGN KEY (`id_profesional`) REFERENCES `profesionales` (`id_profesional`)
...
INSERT INTO `brigadas` VALUES (1,'2026-08-10','Santa Rosa',1),(2,'2026-08-12','El Pueblito',2),(3,'2026-08-14','La Cañada',3),(4,'2026-08-16','Juriquilla',4),(5,'2026-08-18','San Juan del Rio',5);
