...
CREATE TABLE `DIRECCION` (
  `id_dirreccion` varchar(255) PRIMARY KEY NOT NULL,
...
INSERT INTO CLIENTE
(curp_cliente, nombre, apellido_paterno, apellido_materno) VALUES
...
(id_dirreccion, curp_cliente, estado, pais, municipio, calle, numero_int, numero_ext, codigo_postal) VALUES
('DIR001', 'GARC850412HDFRRL09', 'Querétaro', 'México', 'Querétaro', 'Av. Constituyentes', '4B', '125', '76000'),
('DIR002', 'LOPM920715MDFPNS08', 'Querétaro', 'México', 'Corregidora', 'Paseo de los Olivos', NULL, '218', '76900'),
('DIR003', 'HERM880923HQTNRL05', 'Ciudad de México', 'México', 'Coyoacán', 'Av. Miguel Ángel de Quevedo', '12', '453', '04360'),
('DIR004', 'SARM950306MQTNRL07', 'Guanajuato', 'México', 'León', 'Blvd. Campestre', NULL, '876', '37150'),
('DIR005', 'TORL910821HDFRNS04', 'Jalisco', 'México', 'Guadalajara', 'Av. Vallarta', '3A', '1450', '44110');
...
INSERT INTO PAQUETE
(no_seguimiento, curp_cliente, id_direccion, id_repartidor, contenido, cantidad, peso, es_fragil, estado_paquete) VALUES
('MX202608270001', 'GARC850412HDFRRL09', 'DIR001', 1, 'Laptop Lenovo ThinkPad', 1, 2.40, TRUE, 'En tránsito'),
('MX202608270002', 'LOPM920715MDFPNS08', 'DIR002', 2, 'Ropa y accesorios', 6, 3.75, FALSE, 'Entregado'),
('MX202608270003', 'HERM880923HQTNRL05', 'DIR003', 3, 'Libros y material escolar', 8, 5.20, FALSE, 'En tránsito'),
('MX202608270004', 'SARM950306MQTNRL07', 'DIR004', 4, 'Cristalería y artículos decorativos', 4, 4.60, TRUE, 'En almacén'),
('MX202608270005', 'TORL910821HDFRNS04', 'DIR005', 5, 'Audífonos y accesorios electrónicos', 3, 1.35, TRUE, 'Entregado');
