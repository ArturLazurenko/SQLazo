...
CREATE TABLE `refacciones` (
  `id_refacciones` varchar(255) NOT NULL,
  `tipo_refaccion` varchar(255) DEFAULT NULL,
...
INSERT INTO `refacciones` VALUES ('REF001','Filtro de aceite'),('REF002','Aceite de motor'),('REF003','Pastillas de freno'),('REF004','Bateria'),('REF005','Amortiguador delantero'),('REF006','Bujias'),('REF007','Filtro de aire'),('REF008','Balatas traseras');
